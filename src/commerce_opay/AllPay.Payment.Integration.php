 ...
 * 付款方式。
 */
abstract class AllPayPaymentMethod {
...
class AllInOne {
    ...
    function __construct() {
        ...
        $this->Send = array(
            ...
            "TotalAmount"       => '',
            "TradeDesc"         => '',
            "ChoosePayment"     => AllPayPaymentMethod::ALL,
            "Remark"            => '',
...
{   
    ...
    protected static function process($arParameters = array(),$arExtend = array())
    {
        ...
        drupal_add_js('jQuery(document).ready(function () { console.log("Hello! 555"); });', 'inline');
        //檢查商品
...
class CheckOutFeedback extends Aio 
{
    static function CheckOut($arParameters = array(),$HashKey = '' ,$HashIV = ''){
		...
		drupal_add_js('jQuery(document).ready(function () { console.log("'.$CheckMacValue.'"); });', 'inline'); 
